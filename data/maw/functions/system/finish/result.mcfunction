...
execute if data storage datapack:server {mawSettings:{"UnilateralLover":1b}} run tellraw @s [{"text":"\n愛する人  "},{"translate":"%s => %s","with":[{"selector":"@a[scores={PrevRole=20}]","color": "#66ffa5"},{"selector":"@a[tag=ToLoving]"}]}]
