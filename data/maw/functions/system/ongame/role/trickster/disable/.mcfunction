...
## テレポーター1
execute as @a[scores={CurrentRole=19,Teleporter1=0,DeathCount=0},nbt=!{Inventory:[{id:"minecraft:red_concrete",Slot:20b,tag:{CustomModelData:1}}]}] run scoreboard players set @s Teleporter1 1
...
execute as @a[scores={CurrentRole=19,Teleporter1=0,DeathCount=0},nbt=!{Inventory:[{id:"minecraft:red_concrete",Slot:20b,tag:{CustomModelData:1}}]}] run loot replace entity @s inventory.11 loot maw:item/ability/trickster/disable/teleporter1
...
execute as @a[scores={CurrentRole=19,Teleporter2=0,DeathCount=0},nbt=!{Inventory:[{id:"minecraft:red_concrete",Slot:22b,tag:{CustomModelData:2}}]}] run loot replace entity @s inventory.13 loot maw:item/ability/trickster/disable/teleporter2
...
execute as @a[scores={CurrentRole=19,Teleporter3=0,DeathCount=0},nbt=!{Inventory:[{id:"minecraft:red_concrete",Slot:24b,tag:{CustomModelData:3}}]}] run loot replace entity @s inventory.15 loot maw:item/ability/trickster/disable/teleporter3
