...
tellraw @s [{"text":"マフィアの有効化","color": "dark_red","bold": false}]
 tellraw @s [{"text":"        "},{"text":"無効化","bold": true,"clickEvent": {"action": "run_command","value": "/execute if data storage datapack:server {mawSettings:{\"Mafia\":1b}} run data modify storage datapack:server mawSettings merge value {\"Mafia\":0b}"},"hoverEvent": {"action":"show_text","value":{"text":"クリックして「マフィア」を無効化"}}},{"text":"    "},{"text":"有効化","bold": true,"clickEvent": {"action": "run_command","value": "/execute if data storage datapack:server {mawSettings:{\"Mafia\":0b}} run data modify storage datapack:server mawSettings merge value {\"Mafia\":1b}"},"hoverEvent": {"action":"show_text","value":{"text":"クリックして「マフィア」を有効化"}}}]

tellraw @s [{"text":"トリックスターの有効化","color": "dark_red","bold": false}]
 tellraw @s [{"text":"        "},{"text":"無効化","bold": true,"clickEvent": {"action": "run_command","value": "/execute if data storage datapack:server {mawSettings:{\"Trickster\":1b}} run data modify storage datapack:server mawSettings merge value {\"Trickster\":0b}"},"hoverEvent": {"action":"show_text","value":{"text":"クリックして「トリックスター」を無効化"}}},{"text":"    "},{"text":"有効化","bold": true,"clickEvent": {"action": "run_command","value": "/execute if data storage datapack:server {mawSettings:{\"Trickster\":0b}} run data modify storage datapack:server mawSettings merge value {\"Trickster\":1b}"},"hoverEvent": {"action":"show_text","value":{"text":"クリックして「トリックスター」を有効化"}}}]
